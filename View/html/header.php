...
<?php function MainHeader() {?>
        <div id="stickyHeader">            
            <div id="main_header"><!--MAIN HEADER-->
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-5 col-md-6"><!--MINI MENU-->
                            <ul id="mini_menu">
                                ...
                                <li class="col-xs-7 col-md-4 dropdown"><!--ENLACE 2 MINI MENU-->
                                    <a class="dropdown-toggle eClickCarro" data-toggle="dropdown" href="#" aria-expanded="true">CARRITO
    ...
    <!--                                           MEDIANTE JQUERY SE AÑADE CONTENIDO View/js/header.js-->
                                        </div>
...
<?php }?>
<?php function FooterHeader_1() {?>        
            <div id="footer_header"><!--FOOTER HEADER-->
                <nav id="navegador" class="navbar navbar-default animacion_dropdown"><!--FOOTER HEADER NAVEGADOR-->
                    <div class="container">
...
<?php }?>
<?php function FooterHeader_2() {?>
                        <div id="menu" class="collapse navbar-collapse"><!--MENU-->
                            <div class="row">                                                       
<?php }?>
<?php function FooterHeader_3() {?>
                                <div class="sin_padding_RS_LG col-xs-12 col-sm-12 col-md-12 col-lg-6"><!--PARTE IZQUIERDA MENU DROPDOWNS-->
                                    <ul class="nav navbar-nav">                                                         
<?php }?>
<?php function FooterHeader_4_1($varCSS, $ItemsNameMenu, $width) {?>
                                        <li class="<?php echo $varCSS; ?> dropdown"><!--MENU LVL-1-->

                                            <a class="dropdown-toggle hvr-underline-from-left " data-toggle="dropdown" data-hover="dropdown" href="#"><?php echo $ItemsNameMenu; ?>
                                                <span class="fa fa-chevron-down hvr-icon-down "></span>
                                            </a>
                                            <ul class="dropdown-menu container <?php echo $width; ?>"><!--MENU LVL-2-->
                                                <li>
                                                    <div class="padding_dropdown_RS_XS">
                                                        <div class="row">
<?php }?>
<?php function FooterHeader_4_2($sCSS) {?>
                                                            <div class="<?php echo $sCSS; ?>">
                                                                <ul class="links">    
<?php }?>
<?php function FooterHeader_4_3($NameGroup, $QuantElemGroups, $Href, $NoSpaces) {?>
                                                                    <li>
...
<?php }?>
<?php function FooterHeader_4_4() {?>
                                                                </ul>
                                                            </div>
<?php }?>
<?php function FooterHeader_4_5() {?>
                                                        </div><!--END ROW-->
                                                    </div>
                                                </li>
                                            </ul>
...
<?php }?>
<?php function FooterHeader_5($Item_3, $Item_4) {?>
                                        <li><!--MENU LVL-1-->
                                        ...
                                        <form id="search" class="navbar-form navbar_right_RS_LG" role="search"><!--PARTE DERECHA MENU FORM -->
                                            <div class="input-group-btn">
                                                ...
                                                <div class="sin_padding_RS_LG col-xs-12 col-sm-1 col-md-1 col-lg-1"><!--BOTON BUSCAR-->
                                                    <button id="btn_buscar" class="btn btn-success btn-block col_ancho_total " type="submit">
...
<?php }?>
<?php function FooterHeader_7() {?>
                            </div>
                        </div>
                    </div>
                </nav><!--FOOTER HEADER NAVEGADOR-->
            </div><!--END FOOTER HEADER-->    
        </div><!--END DIV STIKY HEADER-->
<?php }?>
<?php function A_1() { ?>
