<?php
require_once 'Controller/generateMenu.php';
?>
                    ...
                    <div class="row">
                        <div class="sin_padding_RS_LG col-xs-12 col-sm-12 col-md-12 col-lg-6"><!--PARTE IZQUIERDA MENU DROPDOWNS-->
                            <ul class="nav navbar-nav"><!--MENU LVL-1-->
                                ...
                                <li><!--MENU LVL-1-->
                                    <a class="link_izq_menu hvr-underline-from-left" href="#">SERVICIOS</a>
                                </li>
                                <li><!--MENU LVL-1-->
                                    <a class="link_izq_menu hvr-underline-from-left" href="#">NOTICIAS</a>
                                </li>
                            </ul>
                        </div>
